...
def main():
    ...
    train_num=sum([len(glob.glob(os.path.join(train_dir,cla,'*.jpg'))) for cla in flower_class])
    test_num=sum([len(glob.glob(os.path.join(test_dir,cla,'*.jpg'))) for cla in flower_class])
