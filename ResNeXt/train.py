...
def main():
    ...
    # download url: https://download.pytorch.org/models/resnext50_32x4d-7cdf4587.pth
    model_weight_path = "./weights/resnext50_32x4d.pth"
    ...
    epochs = 10
    best_acc = 0.0
    save_path = './weights/resnext50_32x4d_flower.pth'
